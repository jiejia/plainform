                ...
                {data.map((item, index) => (
                    <div key={index} className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <div className="relative h-8 bg-default-100 rounded-lg overflow-hidden">
                                <div
                                    className="absolute inset-y-0 left-0 bg-gradient-to-r from-primary to-primary-500 rounded-lg transition-all flex items-center justify-end pr-2"
                        ...
                        <span className="text-sm font-medium text-default-500 w-12 text-right">
                            {item.percentage}%
                        </span>
                    </div>
                ))}
